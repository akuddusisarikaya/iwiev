...
import { createInterview, getInterviews, updateInterviews, deleteInterviews, getinterviewByID } from '../controllers/interview';
...
router.get('/getinterviewbyid/:id', verifyToken, getinterviewByID )
